...
def srcs():
    return shynonon.srcs("raw/Luminous Witches/Luminous Witches - 03 (Amazon dAnime VBR 1080p).mkv",
                         "raw/Luminous Witches/Luminous Witches - 03 (Amazon dAnime CBR 1080p).mkv", comb="lehmer")

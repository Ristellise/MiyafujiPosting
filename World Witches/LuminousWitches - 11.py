...
def srcs():
    return shynonon.srcs("raw/Luminous Witches/Luminous Witches - 11 (Amazon dAnime CBR 1080p).mkv",
                         "raw/Luminous Witches/Luminous Witches - 11 (Amazon dAnime VBR 1080p).mkv", comb="lehmer")
...
# Output
#stgfunc.src("raw/Luminous Witches/Luminous Witches - 11 (Amazon dAnime CBR 1080p).mkv", 16).set_output(0)

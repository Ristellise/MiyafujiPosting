...
def srcs():
    return shynonon.srcs("raw/Luminous Witches/Luminous Witches - 07 (Amazon Prime VBR 1080p).mkv",
                         "raw/Luminous Witches/Luminous Witches - 07 (Amazon Prime CBR 1080p).mkv", comb="lehmer")
...
# Output
#stgfunc.src("raw/Luminous Witches/Luminous Witches - 07 (Amazon Prime VBR 1080p).mkv", 16).set_output(0)
